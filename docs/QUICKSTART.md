...
| Topic | Document |
|-------|----------|
| How the request lifecycle works | [ARCHITECTURE.md](ARCHITECTURE.md) |
| Route parameters and groups | [ROUTING.md](ROUTING.md) |
| Template rendering and layouts | [VIEWS.md](VIEWS.md) |
| Container auto-wiring | [CONTAINER.md](CONTAINER.md) |
