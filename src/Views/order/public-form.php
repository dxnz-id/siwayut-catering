...
<head>
    ...
    <title><?= \App\Core\View::e($title ?? 'Pesan Catering — Siwayut Catering') ?></title>
...
<body>
    ...
    <main class="wrapper">
        <div class="form-card">
            ...
            <p class="subtitle">Isi form di bawah, lalu pesanan akan dikirimkan ke WhatsApp kami.</p>
            ...
            <form action="/order-form" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-input" placeholder="Masukkan nama Anda" value="<?= \App\Core\View::e(old('name')) ?>" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="quantity" name="quantity" class="form-input" placeholder="Contoh: 50" min="1" value="<?= \App\Core\View::e(old('quantity')) ?>" required>
                </div>

                <div class="form-group">
                    <label for="address">Alamat Pengiriman</label>
                    <textarea id="address" name="address" class="form-textarea" placeholder="Masukkan alamat lengkap pengiriman" required><?= \App\Core\View::e(old('address')) ?></textarea>
                </div>

                <div class="form-group">
                    <label for="notes">Catatan <span style="color: var(--text-muted);">(opsional)</span></label>
                    <textarea id="notes" name="notes" class="form-textarea" placeholder="Misal: request tambahan, waktu pengiriman, dll."><?= \App\Core\View::e(old('notes')) ?></textarea>
                </div>
